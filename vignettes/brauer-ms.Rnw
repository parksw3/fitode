...
a_fun <- function(Reff, gamma, S0, I0)
    {(S0/Reff^2)*omega_fun(Reff,gamma,S0,I0)}
...
I0 <- 1
(orig.params.guess <- c(Reff=2, gamma=0.2, S0=1e6)) ## where 1e6 is the population size of bombay at 1990
