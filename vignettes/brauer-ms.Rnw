...
COVID-19 pandemic \cite{Broo+21,Hill+21,Nixo+22,howerton2023evaluation}.
...
\cite{pybus2001epidemic,roberts2007model,wallinga2007generation,KrylEarn13,Cham+18}.  \cref{tab:Bombay} lists the values of
...
to overly narrow confidence intervals on parameters and predictions \citep{li2018fitting}.
