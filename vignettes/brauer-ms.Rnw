...
\item[\code{observation}]specifies that the observed data
  ...
  %%
  \bmb{This is ugly: we won't have coloured text in the paper anyway ... \url{https://stackoverflow.com/questions/48328364/inline-code-format-with-knitr-and-rnw}; \url{https://stackoverflow.com/questions/40252885/how-to-syntax-highlight-inline-r-code-in-r-markdown}?}
...
\item [fit to multiple data streams:] \code{fitode} is not
  ...
  using all of the available data (as in \cite{Nour+2022}).
