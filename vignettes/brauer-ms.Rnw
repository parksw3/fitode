...
\cite[\S3]{bacaermodel2012}\footnote{There is a typographical
error in the original derivation by Baca\"er, where a square term is missing
in the equation above equation (3). We have corrected for this error and
rederived these equations.}, to obtain
\begin{linenomath*}
